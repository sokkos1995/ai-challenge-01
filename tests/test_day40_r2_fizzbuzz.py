...
MODULE_PATH = Path(__file__).resolve().parents[1] / "homeworks" / "artifacts" / "day_40_r2" / "fizzbuzz.py"


def _load():
    spec = importlib.util.spec_from_file_location("day40_r2_fizzbuzz", MODULE_PATH)
